...
path metal_surface_1 = (0,0) -- (0,0.6*height) -- (1,0.6*height) -- (1,0);
path metal_surface_2 = (2,0) -- (2,0.6*height) -- (3,0.6*height) -- (3,0);
path qd_surface = circle((1.5, 0.3*height), 0.4);
path dist = (1,0.1) -- (2,0.1);
path qd_size = (1.1,0.5*height) -- (1.9,0.5*height);
